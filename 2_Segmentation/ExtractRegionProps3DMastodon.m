...
for i=1:length(inputFiles)
    ...
    for j=1:size(resultTable,1)
        ...
        currentGM.setAttribute('W', '0.00140281 -5.92061e-005 0 -5.92061e-005 0.00145949 0 0 0 0.00434088');
        ...
        currentGM.setAttribute('WPrior', '0.044517 -0.00187886 0 -0.00187886 0.0463157 0 0 0 0.137755');
